package de.tum.in.schlichter.shoprx.stereotype.user;
...
public class User {
    ...
    /**
     * Sets the potential stereotypes based on the calculation made by the {@link de.tum.in.schlichter.shoprx.stereotype.controller.StereotypeDeterminator}.
