...
public class Urban extends AbstractStereotype {
    ...
    private void buildBrandMap() {
        ...
        brandProbabilityMap.put(Label.Value.BEN_SHERMAN, 4);
        ...
        brandProbabilityMap.put(Label.Value.CALANDO, 3);
        ...
        brandProbabilityMap.put(Label.Value.CELIO, 6);
        brandProbabilityMap.put(Label.Value.CHANEL, 2);
        brandProbabilityMap.put(Label.Value.COMMA, 3);
        ...
        brandProbabilityMap.put(Label.Value.DOCKERS, 6);
        ...
        brandProbabilityMap.put(Label.Value.FORVERT, 7);
        brandProbabilityMap.put(Label.Value.FRANKLIN_N_MARSHALL, 6);
        brandProbabilityMap.put(Label.Value.G_STAR, 7);
        brandProbabilityMap.put(Label.Value.GAASTRA, 3);
        brandProbabilityMap.put(Label.Value.GANT, 5);
        ...
        brandProbabilityMap.put(Label.Value.JOOP, 3);
        ...
        brandProbabilityMap.put(Label.Value.KOOKAI, 2);
        ...
        brandProbabilityMap.put(Label.Value.LOGOSHIRT, 3);
        ...
        brandProbabilityMap.put(Label.Value.MODSTROEM, 3);
        brandProbabilityMap.put(Label.Value.MORE_N_MORE, 2);
        ...
        brandProbabilityMap.put(Label.Value.OLYMP_LEVEL_5, 4);
        brandProbabilityMap.put(Label.Value.ONLY, 6);
        brandProbabilityMap.put(Label.Value.ONLY_N_SONS, 4);
        brandProbabilityMap.put(Label.Value.OPUS, 5);
        brandProbabilityMap.put(Label.Value.ORLEBAR_BROWN, 9);
        brandProbabilityMap.put(Label.Value.PATAGONIA, 6);
        ...
        brandProbabilityMap.put(Label.Value.PUMA, 7);
        brandProbabilityMap.put(Label.Value.QUIKSILVER, 6);
        ...
        brandProbabilityMap.put(Label.Value.SCHIESSER, 1);
        ...
        brandProbabilityMap.put(Label.Value.SISLEY, 6);
        ...
        brandProbabilityMap.put(Label.Value.VOLCOM, 7);
