...
public class ValueConverter {
    ...
    static {
       ...
       // sDescriptorMap.put("Purple", R.string.purple);
        ...
        //sDescriptorMap.put("Mixed", R.string.);
        ...
        sDescriptorMap.put("less than 25 â‚¬", R.string.less_than_25);
        sDescriptorMap.put("25 to 50 â‚¬", R.string._25_to_50);
        sDescriptorMap.put("50 to 75 â‚¬", R.string._50_to_75);
        sDescriptorMap.put("75 to 100 â‚¬", R.string._75_to_100);
        sDescriptorMap.put("100 to 150 â‚¬", R.string._100_to_150);
        sDescriptorMap.put("150 to 200 â‚¬", R.string._150_to_200);
        sDescriptorMap.put("200 â‚¬ or more", R.string._200_or_more);
    }
