...
//        brandProbabilityMap.put(Label.Value.COMMA, );
...
//        brandProbabilityMap.put(Label.Value.DOCKERS, );
        brandProbabilityMap.put(Label.Value.ESPRIT, 5);
        brandProbabilityMap.put(Label.Value.ETNIES, 1);
//        brandProbabilityMap.put(Label.Value.EVEN_N_ODD, );
//        brandProbabilityMap.put(Label.Value.FILIPPA_K, );
        brandProbabilityMap.put(Label.Value.FJÄLLRÄVEN, 3);
        brandProbabilityMap.put(Label.Value.FOREVER_21, 3);
//        brandProbabilityMap.put(Label.Value.FORVERT, );
//        brandProbabilityMap.put(Label.Value.FRANKLIN_N_MARSHALL, );
        brandProbabilityMap.put(Label.Value.G_STAR, 5);
//        brandProbabilityMap.put(Label.Value.GAASTRA, );
//        brandProbabilityMap.put(Label.Value.GANT, );
        brandProbabilityMap.put(Label.Value.GUCCI, 8);
//        brandProbabilityMap.put(Label.Value.GUESS, );
...
//        brandProbabilityMap.put(Label.Value.HOM, );
...
//        brandProbabilityMap.put(Label.Value.J_LINDEBERG, );
//        brandProbabilityMap.put(Label.Value.JACK_N_JONES, );
//        brandProbabilityMap.put(Label.Value.JOOP, );
//        brandProbabilityMap.put(Label.Value.KAFFE, );
//        brandProbabilityMap.put(Label.Value.KHUJO, );
//        brandProbabilityMap.put(Label.Value.KIOMI, );
//        brandProbabilityMap.put(Label.Value.KOOKAI, );
...
//        brandProbabilityMap.put(Label.Value.LOGOSHIRT, );
        brandProbabilityMap.put(Label.Value.LOUIS_VUITTON, 9);
        brandProbabilityMap.put(Label.Value.LRG, 1);
//        brandProbabilityMap.put(Label.Value.LTB, );
//        brandProbabilityMap.put(Label.Value.LYLE_N_SCOTT, );
//        brandProbabilityMap.put(Label.Value.MAMA_LICIOUS, );
//        brandProbabilityMap.put(Label.Value.MARC_O_POLO, );
//        brandProbabilityMap.put(Label.Value.MAVI, );
//        brandProbabilityMap.put(Label.Value.MAZE, );
...
//        brandProbabilityMap.put(Label.Value.OAKWOOD, );
//        brandProbabilityMap.put(Label.Value.OLYMP_LEVEL_5, );
//        brandProbabilityMap.put(Label.Value.ONLY, );
//        brandProbabilityMap.put(Label.Value.ONLY_N_SONS, );
//        brandProbabilityMap.put(Label.Value.OPUS, );
//        brandProbabilityMap.put(Label.Value.ORLEBAR_BROWN, );
//        brandProbabilityMap.put(Label.Value.PATAGONIA, );
        brandProbabilityMap.put(Label.Value.PEPE, 5);
//        brandProbabilityMap.put(Label.Value.PIER_ONE, );
